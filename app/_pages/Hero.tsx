...
function HeroProps({props}:Props) {
    return(
        ...
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 className="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">{props.herotitle}</h1>
            <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">{props.herodescription}</p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                ...
                <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">{props.herosubtitle}</h2>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                ...
                <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2"></h2>
                <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4"></p>
                <Link href="#" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Read more
                    <svg className="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
